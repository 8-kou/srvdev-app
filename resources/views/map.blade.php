    ...
    <div class="bg-white p-6 rounded-xl shadow-sm">
        <div class="mb-8">
            ...
            <div class="aspect-video w-full bg-gray-100 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300 overflow-hidden relative">
                ...
                <img id="main-map-image" src="" alt="校舎マップ" class="hidden w-full h-full object-contain bg-white">
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div class="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <button onclick="showMap('/images/KBC8階.png', '8F 詳細マップ')" class="w-full flex flex-col md:flex-row text-left bg-white hover:bg-blue-50 transition-colors cursor-pointer group focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="p-4 flex-1 flex justify-between items-center">
                        <div>
                            <h3 class="font-bold text-gray-800 mb-1">CBTセンター・ホール・教室</h3>
                            <div class="text-sm text-gray-600 space-y-1">
                                <p>803: CBTセンター</p>
                                <p>801, 802: 教室</p>
                                <p>804: 準備室</p>
                                <p>ホール・倉庫</p>
                                <p class="text-xs text-gray-500">トイレ(男女)・喫煙所(バルコニー)・エレベーター</p>
                            </div>
                        </div>
                    ...
                    <div class="p-4 flex-1 flex justify-between items-center">
                        <div>
                            ...
                            <div class="text-sm text-gray-600 space-y-1">
                                ...
                                <p>406: ガイダンス室</p>
                                <p class="text-xs text-gray-500">トイレ(男女)・喫煙所・エレベーター</p>
                            </div>
                        </div>
                        <span class="text-xs text-blue-600 font-bold border border-blue-200 bg-white px-3 py-1 rounded-full group-hover:bg-blue-600 group-hover:text-white transition-colors">
                            上に表示
                ...
                <button onclick="showMap('/images/KBC3階.png', '3F 詳細マップ')" class="w-full flex flex-col md:flex-row text-left bg-white hover:bg-blue-50 transition-colors cursor-pointer group focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="p-4 flex-1 flex justify-between items-center">
                        <div>
                            ...
                            <div class="text-sm text-gray-600 space-y-1">
                                <p>301: 学生サロン</p>
                                <p>302, 304: ITエンジニア科(グラフィック/ゲーム)</p>
                                <p>303: NWラボ</p>
                                <p class="text-xs text-gray-500">学園本部・トイレ(男女/多目的)・喫煙所</p>
                            </div>
                        </div>
                        <span class="text-xs text-blue-600 font-bold border border-blue-200 bg-white px-3 py-1 rounded-full group-hover:bg-blue-600 group-hover:text-white transition-colors">
                            上に表示
            ...
            <div class="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <button onclick="showMap('/images/KBC2階.png', '2F 詳細マップ')" class="w-full flex flex-col md:flex-row text-left bg-white hover:bg-blue-50 transition-colors cursor-pointer group focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <div class="bg-blue-600 text-white w-full md:w-24 flex items-center justify-center p-2 font-bold text-xl group-hover:bg-blue-700">
                        2F
                    </div>
                    <div class="p-4 flex-1 flex justify-between items-center">
                        <div>
                            <h3 class="font-bold text-gray-800 mb-1">事務局・職員室・教務</h3>
                            <div class="text-sm text-gray-600 space-y-1">
                                <p>事務局・教務室・校長室・保健室</p>
                                <p>会議室・応接室・ホール・ロビー</p>
                                <p>201, 202, 203, 204: 教室</p>
                                <p class="text-xs text-gray-500">書庫室・倉庫・喫煙所・エレベーター・外階段</p>
                            </div>
                        </div>
                        <span class="text-xs text-blue-600 font-bold border border-blue-200 bg-white px-3 py-1 rounded-full group-hover:bg-blue-600 group-hover:text-white transition-colors">
                            上に表示
                    ...
                    <div class="p-4 flex-1 flex justify-between items-center">
                        <div>
                            ...
                            <div class="text-sm text-gray-600 space-y-1">
                                ...
                                <p>倉庫・エレベーター・外階段</p>
                                <p class="text-xs text-gray-500">南側出口・壺川中公園（避難場所）方面</p>
                            </div>
                        </div>
                        <span class="text-xs text-blue-600 font-bold border border-blue-200 bg-white px-3 py-1 rounded-full group-hover:bg-blue-600 group-hover:text-white transition-colors">
                            上に表示
